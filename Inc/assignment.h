...
#define LED_ON					*((volatile uint32_t *)((uint32_t)(GPIOA_BASE_ADDR + 0x18U))) |= (1 << 4)   	//GPIOA pin 4
#define LED_OFF					*((volatile uint32_t *)((uint32_t)GPIOA_BASE_ADDR + 0x28U)) |= (1 << 4);		//GPIOA pin 4

#define BUTTON_GET_STATE		!(*((volatile uint32_t *)((uint32_t)(GPIOA_BASE_ADDR + 0x10U))) & (1 << 3))  //GPIOA read pin 3
